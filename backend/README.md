...
## Project Structure
    ...
    ├── testapiautostoryboa_70273  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_70273`
...
2. Clone this repo and `cd testapiautostoryboa_70273`
